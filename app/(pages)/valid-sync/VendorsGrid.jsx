...
export default function VendorsGrid() {
  ...
  return (
    <div className='vendors-grid-container'>
      <h1 className='text-2xl font-bold text-center my-6 fade-in'>
        Preferred Vendors
      </h1>
      <div className='card-grid'>
        {vendors.map((vendor, idx) => (
          <div
            className={`card ${
              visibleCards.includes(idx) ? 'fade-in-up' : 'opacity-0'
            }`}
            key={idx}
          ...
          >
            ...
            <div className='card-body'>
              <p>
                <strong>License:</strong> {vendor.license}
              </p>
              <p>
                <strong>Last Verified:</strong> {vendor.lastVerified}
              </p>
              <p>
                <strong>Expiration Date:</strong> {vendor.expirationDate}
              </p>
            </div>
